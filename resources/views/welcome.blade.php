...
<body class="antialiased">
    <div class="background relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
        <img class="img" src="/storage/images/inwos/logo.png" alt="inwos" width="50%">
        @if (Route::has('login'))
        <div class="buttons hidden fixed top-1 right-2 px-6 py-4 sm:block">
            <div class="test">
                @auth
                <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a>
                @else
                <a href="{{ route('login') }}" class="btn btn-primary">{{ __('Login') }}</a></a>
